...
jQuery.fn.daterangepicker = function(settings){
    ...
    if (options.posY == null || options.posX == null){

        localParent.css("z-index","1010");
        localParent.css("position","absolute");
        localParent.css("top", Math.max(0, (($(window).height() - this.outerHeight()) / 2) +
            $(window).scrollTop()) + "px");
        localParent.css("left", Math.max(0, (($(window).width() - this.outerWidth()) / 2) +
